...
kf_1_min_dat_skipped <- read_csv("data/15_seconds/Kakadu_fish_pred_1_min.csv")
tb_1_min_dat_skipped <- read_csv("data/15_seconds/Tassie_BRUV_RUV_pred_1_min.csv")
...
write.csv(true_sum_all_kf,"results/15_seconds/goal_1_2_4_dat_kf.csv")
write.csv(true_sum_all_tb,"results/15_seconds/goal_1_2_4_dat_tb.csv")
...
write.csv(goal_2_4_dat_kf_long,"results/15_seconds/goal_1_2_4_dat_kf_long.csv")
write.csv(goal_2_4_dat_tb_long,"results/15_seconds/goal_1_2_4_dat_tb_long.csv")
...
write.csv(tb_1_min_dat,"results/15_seconds/goal_2_dat_tb.csv")
...
write.csv(kf_1_min_dat,"results/15_seconds/goal_2_dat_kf.csv")
...
write.csv(goal_2_dat_kf_long,"results/15_seconds/goal_2_dat_kf_long.csv")
write.csv(goal_2_dat_tb_long,"results/15_seconds/goal_2_dat_tb_long.csv")
