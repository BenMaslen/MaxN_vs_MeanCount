...
test_statistic_dat_kf = read.csv("results/30_seconds/goal_4_test_statistic_dat_kf.csv")  
test_statistic_dat_tb = read.csv("results/30_seconds/goal_4_test_statistic_dat_tb.csv")  
...
p_values_dat_kf <- read.csv("results/30_seconds/p_values_dat_kf.csv")
p_values_dat_tb <- read.csv("results/30_seconds/p_values_dat_tb.csv")
...
pow_4 <- read.csv("data/30_seconds/power_dat/power_10_20_4_1000.csv")
pow_8 <- read.csv("data/30_seconds/power_dat/power_10_20_8_1000.csv")
pow_12 <- read.csv("data/30_seconds/power_dat/power_10_20_12_1000.csv")
pow_16 <- read.csv("data/30_seconds/power_dat/power_10_20_16_1000.csv")
pow_20 <- read.csv("data/30_seconds/power_dat/power_10_20_20_1000.csv")
pow_24 <- read.csv("data/30_seconds/power_dat/power_10_20_24_1000.csv")
pow_28 <- read.csv("data/30_seconds/power_dat/power_10_20_28_1000.csv")
pow_32 <- read.csv("data/30_seconds/power_dat/power_10_20_32_1000.csv")
pow_36 <- read.csv("data/30_seconds/power_dat/power_10_20_36_1000.csv")
pow_40 <- read.csv("data/30_seconds/power_dat/power_10_20_40_1000.csv")
...
raw_12 <- read.csv("data/30_seconds/power_dat/raw_data_10_20_12_1000.csv")
...
ggsave("plots/30_seconds/goal_4_combined_plot.png",height=1.1*5.12,width=1.1*5.79*(0.98/0.62))
...
ggsave("plots/30_seconds/goal_4_combined_plot2.png",height=1.1*5.12,width=1.1*5.79*(0.98/0.62))
