...
goal_3_dat_tb <- read_csv("results/30_seconds/goal_3_dat_tb.csv")
goal_3_dat_kf <- read_csv("results/30_seconds/goal_3_dat_kf.csv")
...
mean_var_dat <- read.csv("results/30_seconds/simulation_goal3_dat.csv")
...
mean_var_dat_summary %>% filter(pop_means == 10)
...
ggsave("plots/30_seconds/goal3_plot_bias.png",height=1.1*5.12,width=1.1*5.79*(0.98/0.62))
...
ggsave("plots/30_seconds/goal3_plot_var.png",height=1.1*5.12,width=1.1*5.79*(0.98/0.62))
