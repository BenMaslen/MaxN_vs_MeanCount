...
kf_4_min_dat_skipped <- read_csv("data/30_seconds/Kakadu_fish_pred.csv")
tb_4_min_dat_skipped <- read_csv("data/30_seconds/Tassie_BRUV_RUV_pred.csv")
...
write.csv(resamp_sum_all_mean_long_tb,"results/30_seconds/goal_3_dat_tb.csv")
write.csv(resamp_sum_all_mean_long_kf,"results/30_seconds/goal_3_dat_kf.csv")
