...
goal_4_dat_tb$value_sum = round(goal_4_dat_tb$value*goal_4_dat_tb$frame_rate*60*goal_4_dat_tb$vid_length_new) #round to handle rounding cases
...
#try and fix the convergence issues
