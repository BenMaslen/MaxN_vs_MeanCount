...
goal_1_dat_tb <- read_csv("results/goal_1_2_4_dat_tb.csv")
goal_1_dat_kf <- read_csv("results/goal_1_2_4_dat_kf.csv")
...
goal_1_sim_dat <- read.csv("results/simulation_goal1_dat.csv")
...
ggsave("plots/MaxN_AvgN_scatter_sims.png",height=1.1*5.12,width=1.1*5.79*(0.98/0.62))
